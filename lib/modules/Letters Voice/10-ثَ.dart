...
class _d1State extends State<d1> {
  ...
  var SaveRoad;
  final D1Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter10 = 1010;
  final UrlD1 = 'gs://speakup-430fa.appspot.com/ث-الفتحة.mp3';
  // final EmailUser =
  ...
  SaveDataLetter10() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter10', 1010);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urld1 = UrlD1;
                          await D1Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%AB-%D8%A7%D9%84%D9%81%D8%AA%D8%AD%D8%A9.mp3?alt=media&token=e561d4fa-5bd3-4bdb-a165-dba1350af5d6'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/ثَ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'ثَُ');
