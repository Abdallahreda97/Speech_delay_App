...
class _o2State extends State<o2> {
  ...
  var SaveRoad;
  final O2Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter44 = 1044;
  final UrlO2 = 'gs://speakup-430fa.appspot.com/ض-الكسرة.mp3';
  // final EmailUser =
  ...
  SaveDataLetter44() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setInt('idLetter44', 1044);
    print("Success");
  }
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlo2 = UrlO2;
                          await O2Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B6-%D8%A7%D9%84%D9%83%D8%B3%D8%B1%D8%A9.mp3?alt=media&token=e2491b5d-350c-4c6f-bae9-3e2311dfd7bd'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/ضِ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'ض');
