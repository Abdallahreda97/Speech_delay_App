...
class _s1State extends State<s1> {
  ...
  var SaveRoad;
  final S1Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter55 = 1055;
  final UrlS1 = 'gs://speakup-430fa.appspot.com/غ-الفتحة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
    ...
    setState(() {});
     ...
     SaveDataLetter55() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter55', 1055);
      print("Success");
    }
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urls1 = UrlS1;
                          await S1Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%BA-%D8%A7%D9%84%D9%81%D8%AA%D8%AD%D8%A9.mp3?alt=media&token=9a08affa-5823-4454-a867-6a744b014223'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/غَ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
