...
class _g2State extends State<g2> {
  ...
  var SaveRoad;
  final G2Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  final UrlG2 = 'gs://speakup-430fa.appspot.com/خ-الكسرة.mp3';
  int idLetter20 = 1020;
  // final EmailUser =
  ...
  SaveDataLetter20() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setInt('idLetter20', 1020);
    print("Success");
  }
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlg2 = UrlG2;
                          await G2Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%AE-%D8%A7%D9%84%D9%83%D8%B3%D8%B1%D8%A9.mp3?alt=media&token=efb85983-bafc-4d8d-871a-bd179cd6289f'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/خِ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'خُِ');
