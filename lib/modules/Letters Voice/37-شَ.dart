...
class _m1State extends State<m1> {
  ...
  var SaveRoad;
  final M1Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  final UrlM1 = 'gs://speakup-430fa.appspot.com/ش-الفتحة.mp3';
  int idLetter37 = 1037;
  // final EmailUser =
  ...
  Future initRecorder() async {
   ...
   SaveDataLetter37() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter37', 1037);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlm1 = UrlM1;
                          await M1Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B4-%D8%A7%D9%84%D9%81%D8%AA%D8%AD%D8%A9.mp3?alt=media&token=b1d5012f-2163-42b5-a81b-1a8680033f98'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/شَ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
