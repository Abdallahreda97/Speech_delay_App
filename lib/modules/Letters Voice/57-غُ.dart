...
class _s3State extends State<s3> {
  ...
  var SaveRoad;
  final S3Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  final UrlS3 = 'gs://speakup-430fa.appspot.com/غ-الضمة.mp3';
  int idLetter57 = 1057;
  // final EmailUser =
  ...
  Future initRecorder() async {
    ...
    SaveDataLetter57() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter57', 1057);
      print("Success");
    }
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urls3 = UrlS3;
                          await S3Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%BA-%D8%A7%D9%84%D8%B6%D9%85%D8%A9.mp3?alt=media&token=2ea643bd-86d9-469d-933e-f8df8c561983'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/غُ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
