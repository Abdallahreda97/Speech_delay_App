...
class h3 extends StatefulWidget {
  const h3({Key? key}) : super(key: key);
...
class _h3State extends State<h3> {
  ...
  var SaveRoad;
  final H3Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter24 = 1024;
  final UrlH3 = 'gs://speakup-430fa.appspot.com/د-الضمة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
   ...
   SaveDataLetter24() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter24', 1024);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlh3 = UrlH3;
                          await H3Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%AF-%D8%A7%D9%84%D8%B6%D9%85%D8%A9.mp3?alt=media&token=d0bc8c0e-8eb9-4057-b70e-5204beaa43b1'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/دُ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'دَُ');
