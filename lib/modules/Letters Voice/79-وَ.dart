...
class z31 extends StatefulWidget {
  const z31({Key? key}) : super(key: key);

  @override
  State<z31> createState() => _z31State();
}

class _z31State extends State<z31> {
  DateTime? _lastPressedAt;
  var SaveRoad;
  final Z31Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter79 = 1079;
  final UrlZ31 = 'gs://speakup-430fa.appspot.com/و-الفتحة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
    ...
    setState(() {});
     ...
     SaveDataLetter79() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter79', 1079);
      print("Success");
    }
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlz31 = UrlZ31;
                          await Z31Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%88-%D8%A7%D9%84%D9%81%D8%AA%D8%AD%D8%A9.mp3?alt=media&token=4b47cef3-955b-408e-801b-e5900ca74c9a'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/وَ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
