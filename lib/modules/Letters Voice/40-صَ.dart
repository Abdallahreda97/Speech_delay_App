...
class _n1State extends State<n1> {
  ...
  var SaveRoad;
  final N1Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter40 = 1040;
  final UrlN1 = 'gs://speakup-430fa.appspot.com/ص-الفتحة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
   ...
   SaveDataLetter40() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter40', 1040);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urln1 = UrlN1;
                          await N1Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B5-%D8%A7%D9%84%D9%81%D8%AA%D8%AD%D8%A9.mp3?alt=media&token=76b7ffeb-16bc-4074-80ec-33ef72fc3916'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/صَ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
