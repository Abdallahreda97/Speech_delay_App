...
class _k2State extends State<k2> {
  ...
  var SaveRoad;
  final K2Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  final UrlK2 = 'gs://speakup-430fa.appspot.com/ز-الكسرة.mp3';
  int idLetter32 = 1032;
  // final EmailUser =
  ...
  Future initRecorder() async {
   ...
   SaveDataLetter32() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter32', 1032);
      print("Success");
    }
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlk2 = UrlK2;
                          await K2Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B2-%D8%A7%D9%84%D9%83%D8%B3%D8%B1%D8%A9.mp3?alt=media&token=0417da0c-a543-4d25-97b0-73b06055a382'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/زِ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'ز');
