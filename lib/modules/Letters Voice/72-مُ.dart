...
class x3 extends StatefulWidget {
  const x3({Key? key}) : super(key: key);

  @override
  State<x3> createState() => _x3State();
}

class _x3State extends State<x3> {
  DateTime? _lastPressedAt;
  var SaveRoad;
  final X3Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter72 = 1072;
  final UrlX3 = 'gs://speakup-430fa.appspot.com/م-الضمة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
    ...
    SaveDataLetter72() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter72', 1072);
      print("Success");
    }
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlx3 = UrlX3;
                          await X3Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%85-%D8%A7%D9%84%D8%B6%D9%85%D8%A9.mp3?alt=media&token=83476782-ce2c-48ce-9ebd-bad425a902de'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/مُ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
