...
class _a2State extends State<a2> {
  ...
  var SaveRoad;
  final A2Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  final UrlA2 = 'gs://speakup-430fa.appspot.com/أ-الكسرة.mp3';
  int idLetter2 = 1002;
  // final EmailUser =
  ...
  SaveDataLetter2() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setInt('idLetter2', 1002);
    print("Success");
  }
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urla2 = UrlA2;
                          await A2Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A3-%D8%A7%D9%84%D9%83%D8%B3%D8%B1%D8%A9.mp3?alt=media&token=063fd759-461e-422c-b2a9-9d6feec6a34b'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/إِ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'إَِ');
