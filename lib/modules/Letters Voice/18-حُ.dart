...
class _f3State extends State<f3> {
  ...
  var SaveRoad;
  final F3Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter18 = 1018;
  final UrlF3 = 'gs://speakup-430fa.appspot.com/ح-الضمة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
    ...
    SaveDataLetter18() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter18', 1018);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlf3 = UrlF3;
                          await F3Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%AD-%D8%A7%D9%84%D8%B6%D9%85%D8%A9.mp3?alt=media&token=9279f27c-e246-43f5-9a8a-c3ac12450427'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/حُ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'حُ');
