...
class y1 extends StatefulWidget {
  const y1({Key? key}) : super(key: key);

  @override
  State<y1> createState() => _y1State();
}

class _y1State extends State<y1> {
  DateTime? _lastPressedAt;
  var SaveRoad;
  final Y1Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter73 = 1073;
  final UrlY1 = 'gs://speakup-430fa.appspot.com/ن-الفتحة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
    ...
    SaveDataLetter73() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter73', 1073);
      print("Success");
    }
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urly1 = UrlY1;
                          await Y1Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%86-%D8%A7%D9%84%D9%81%D8%AA%D8%AD%D8%A9.mp3?alt=media&token=09ddd914-3dff-40b3-b53f-7e45a97277ad'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/نَ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'ن');
