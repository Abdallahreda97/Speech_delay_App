...
class y2 extends StatefulWidget {
  const y2({Key? key}) : super(key: key);

  @override
  State<y2> createState() => _y2State();
}

class _y2State extends State<y2> {
  DateTime? _lastPressedAt;
  var SaveRoad;
  final Y2Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter74 = 1074;
  final UrlY2 = 'gs://speakup-430fa.appspot.com/ن-الكسرة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
    ...
    SaveDataLetter74() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter74', 1074);
      print("Success");
    }
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urly2 = UrlY2;
                          await Y2Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%86-%D8%A7%D9%84%D9%83%D8%B3%D8%B1%D8%A9.mp3?alt=media&token=173653f7-f9ed-4323-bf46-27feae4e959c'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/نِ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
