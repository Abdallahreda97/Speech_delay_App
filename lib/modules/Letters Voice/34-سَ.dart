...
class _l1State extends State<l1> {
  ...
  var SaveRoad;
  final L1Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  final UrlL1 = 'gs://speakup-430fa.appspot.com/س-الفتحة.mp3';
  int idLetter34 = 1034;
  // final EmailUser =
  ...
  Future initRecorder() async {
   ...
   SaveDataLetter34() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter34', 1034);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urll1 = UrlL1;
                          await L1Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B3-%D8%A7%D9%84%D9%81%D8%AA%D8%AD%D8%A9.mp3?alt=media&token=e655c97e-9205-4a67-85a0-6d5ef05b08bc'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/سَ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
