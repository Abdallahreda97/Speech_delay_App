...
class _c3State extends State<c3> {
  ...
  var SaveRoad;
  final C3Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter9 = 1009;
  final UrlC3 = 'gs://speakup-430fa.appspot.com/ت-الضمة.mp3';
  // final EmailUser =
  ...
  SaveDataLetter9() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter9', 1009);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlc3 = UrlC3;
                          await C3Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%AA-%D8%A7%D9%84%D8%B6%D9%85%D8%A9.mp3?alt=media&token=a4cc7c07-5c1d-4012-b685-d2e328219863'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/تُ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'تُُ');
