...
class _g3State extends State<g3> {
  ...
  var SaveRoad;
  final G3Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter21 = 1021;
  final UrlG3 = 'gs://speakup-430fa.appspot.com/خ-الضمة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
   ...
   SaveDataLetter21() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter21', 1021);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlg3 = UrlG3;
                          await G3Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%AE-%D8%A7%D9%84%D8%B6%D9%85%D8%A9.mp3?alt=media&token=e0e2b66a-e202-460c-bce2-5ad74b7f530f'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/خُ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'خُُ');
