...
class j1 extends StatefulWidget {
  const j1({Key? key}) : super(key: key);

  @override
  State<j1> createState() => _j1State();
}

class _j1State extends State<j1> {
  DateTime? _lastPressedAt;
  var SaveRoad;
  final J1Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter28 = 1028;
  final UrlJ1 = 'gs://speakup-430fa.appspot.com/ر-الفتحة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
   ...
   SaveDataLetter28() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter28', 1028);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlj1 = UrlJ1;
                          await J1Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B1-%D8%A7%D9%84%D9%81%D8%AA%D8%AD%D8%A9.mp3?alt=media&token=c4a5df96-683d-4a47-a238-4b8484de5708'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/رَ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
