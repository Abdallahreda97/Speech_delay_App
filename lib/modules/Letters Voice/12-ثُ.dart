...
class _d3State extends State<d3> {
  ...
  var SaveRoad;
  final D3Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter12 = 1012;
  final UrlD3 = 'gs://speakup-430fa.appspot.com/ث-الضمة.mp3';
  // final EmailUser =
  ...
  SaveDataLetter12() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter12', 1012);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urld3 = UrlD3;
                          await D3Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%AB-%D8%A7%D9%84%D8%B6%D9%85%D8%A9.mp3?alt=media&token=4e9458fd-87aa-4901-aa5b-f9dfff31af9a'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/ثُ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'ثُُ');
