...
class _w3State extends State<w3> {
  ...
  var SaveRoad;
  final W3Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter69 = 1069;
  final UrlW3 = 'gs://speakup-430fa.appspot.com/ل-الضمة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
    ...
    SaveDataLetter69() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter69', 1069);
      print("Success");
    }
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlw3 = UrlW3;
                          await W3Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%84-%D8%A7%D9%84%D8%B6%D9%85%D8%A9.mp3?alt=media&token=dc48dde5-e4a4-4d3a-995b-a835fd9ad2f3'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/لُ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
