...
class _i3State extends State<i3> {
  ...
  var SaveRoad;
  final I3Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter26 = 1026;
  final UrlI3 = 'gs://speakup-430fa.appspot.com/ذ-الضمة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
   ...
   SaveDataLetter27() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter27', 1027);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urli3 = UrlI3;
                          await I3Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B0-%D8%A7%D9%84%D8%B6%D9%85%D8%A9.mp3?alt=media&token=54e2057d-735c-4447-aa81-509f8cb32013'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/ذُ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
