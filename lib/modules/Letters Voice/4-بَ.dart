...
class _b1State extends State<b1> {
  ...
  var SaveRoad;
  final B1Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter4 = 1004;
  final UrlB1 = 'gs://speakup-430fa.appspot.com/ب-الفتحة.mp3';
  // final EmailUser =
  ...
  SaveDataLetter4() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setInt('idLetter4', 1004);
    print("Success");
  }
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlb1 = UrlB1;
                          await B1Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A8-%D8%A7%D9%84%D9%81%D8%AA%D8%AD%D8%A9.mp3?alt=media&token=3396ded7-61ae-4c2f-8391-67de0e529345'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/بَ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'ب');
