...
class _w2State extends State<w2> {
  ...
  var SaveRoad;
  final W2Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter68 = 1068;
  final UrlW2 = 'gs://speakup-430fa.appspot.com/ل-الكسرة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
    ...
    SaveDataLetter68() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter68', 1068);
      print("Success");
    }
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlw2 = UrlW2;
                          await W2Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%84-%D8%A7%D9%84%D9%83%D8%B3%D8%B1%D8%A9.mp3?alt=media&token=23149d2a-1a84-4591-8b57-8937a268346b'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/لِ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
