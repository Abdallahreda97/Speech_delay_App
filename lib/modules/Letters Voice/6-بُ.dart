...
class _b3State extends State<b3> {
  ...
  var SaveRoad;
  final B3Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter6 = 1006;
  final UrlB3 = 'gs://speakup-430fa.appspot.com/ب-الضمة.mp3';
  // final EmailUser =
  ...
  SaveDataLetter6() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter6', 1006);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlb3 = UrlB3;
                          await B3Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A8-%D8%A7%D9%84%D8%B6%D9%85%D8%A9.mp3?alt=media&token=3a2d02a7-1f8f-4fef-ab5b-6986697b2dbd'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/بُ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'بُ');
