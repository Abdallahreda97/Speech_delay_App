...
class _e3State extends State<e3> {
  ...
  var SaveRoad;
  final E3Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter15 = 1015;
  final UrlE3 = 'gs://speakup-430fa.appspot.com/ج-الضمة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
   ...
   SaveDataLetter15() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter15', 1015);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urle3 = UrlE3;
                          await E3Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%AC-%D8%A7%D9%84%D8%B6%D9%85%D8%A9.mp3?alt=media&token=02969ea0-23d9-4960-b4dc-41d59305b05c'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/جُ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'جُُ');
