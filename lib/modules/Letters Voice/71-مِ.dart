...
class x2 extends StatefulWidget {
  const x2({Key? key}) : super(key: key);

  @override
  State<x2> createState() => _x2State();
}

class _x2State extends State<x2> {
  DateTime? _lastPressedAt;
  var SaveRoad;
  final X2Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter71 = 1071;
  final UrlX2 = 'gs://speakup-430fa.appspot.com/م-الكسرة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
   ...
   SaveDataLetter71() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter71', 1071);
      print("Success");
    }
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlx2 = UrlX2;
                          await X2Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%85-%D8%A7%D9%84%D9%83%D8%B3%D8%B1%D8%A9.mp3?alt=media&token=260e3080-3086-423e-963d-72027ba8b784'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/مِ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'م');
