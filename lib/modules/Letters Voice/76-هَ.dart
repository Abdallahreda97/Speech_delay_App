...
class z1 extends StatefulWidget {
  const z1({Key? key}) : super(key: key);

  @override
  State<z1> createState() => _z1State();
}

class _z1State extends State<z1> {
  DateTime? _lastPressedAt;
  var SaveRoad;
  final Z1Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter76 = 1076;
  final UrlZ1 = 'gs://speakup-430fa.appspot.com/ه-الفتحة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
   ...
   SaveDataLetter76() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter76', 1076);
      print("Success");
    }
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlz1 = UrlZ1;
                          await Z1Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%87-%D8%A7%D9%84%D9%81%D8%AA%D8%AD%D8%A9.mp3?alt=media&token=fb1a4347-ea40-4989-838b-1b8ff36a282a'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/هَ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'ه');
