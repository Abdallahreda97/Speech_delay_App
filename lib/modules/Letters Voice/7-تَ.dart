...
class _c1State extends State<c1> {
  ...
  var SaveRoad;
  final C1Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter7 = 1007;
  final UrlC1 = 'gs://speakup-430fa.appspot.com/ت-الفتحة.mp3';
  // final EmailUser =
  ...
  SaveDataLetter7() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter7', 1007);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlc1 = UrlC1;
                          await C1Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%AA-%D8%A7%D9%84%D9%81%D8%AA%D8%AD%D8%A9.mp3?alt=media&token=3967244d-953d-4fd9-b3b8-1169150f4562'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/تَ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'تَُ');
