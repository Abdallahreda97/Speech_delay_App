...
class _e1State extends State<e1> {
  ...
  var SaveRoad;
  final E1Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter13 = 1013;
  final UrlE1 = 'gs://speakup-430fa.appspot.com/ج-الفتحة.mp3';
  // final EmailUser =
  ...
  SaveDataLetter13() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter13', 1013);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urle1 = UrlE1;
                          await E1Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%AC-%D8%A7%D9%84%D9%81%D8%AA%D8%AD%D8%A9.mp3?alt=media&token=8e99ef9b-f060-4298-ba7c-cdd1720fc483'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/جَ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'جَُ');
