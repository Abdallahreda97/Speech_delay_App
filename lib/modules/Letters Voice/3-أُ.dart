...
class _a3State extends State<a3> {
  ...
  var SaveRoad;
  final A3Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter3 = 1003;
  final UrlA3 = 'gs://speakup-430fa.appspot.com/أ-الضمة.mp3';
  // final EmailUser =
  ...
  SaveDataLetter3() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setInt('idLetter3', 1003);
    print("Success");
  }
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urla3 = UrlA3;
                          await A3Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A3-%D8%A7%D9%84%D8%B6%D9%85%D8%A9.mp3?alt=media&token=8f48ea57-c024-475c-9a6f-5c0cc69d0b49'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/أُ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'أُ');
