...
class u2 extends StatefulWidget {
  const u2({Key? key}) : super(key: key);

  @override
  State<u2> createState() => _u2State();
}

class _u2State extends State<u2> {
  DateTime? _lastPressedAt;
  var SaveRoad;
  final U2Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter62 = 1062;
  final UrlU2 = 'gs://speakup-430fa.appspot.com/ق-الكسرة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
    ...
    SaveDataLetter62() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter62', 1062);
      print("Success");
    }
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlu2 = UrlU2;
                          await U2Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%82-%D8%A7%D9%84%D9%83%D8%B3%D8%B1%D8%A9.mp3?alt=media&token=2faf71ed-bc16-45c1-99fc-a07aee6abf71'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/قِ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className:'ق');
