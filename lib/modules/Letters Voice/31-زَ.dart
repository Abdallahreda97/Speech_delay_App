...
class _k1State extends State<k1> {
  ...
  var SaveRoad;
  final K1Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter31 = 1031;
  final UrlK1 = 'gs://speakup-430fa.appspot.com/ز-الفتحة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
   ...
   SaveDataLetter31() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter31', 1031);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlk1 = UrlK1;
                          await K1Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B2-%D8%A7%D9%84%D9%81%D8%AA%D8%AD%D8%A9.mp3?alt=media&token=bc90f3c8-4f24-43db-a163-ac22e1302872'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/زَ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
