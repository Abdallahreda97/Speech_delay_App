...
class _o1State extends State<o1> {
  ...
  var SaveRoad;
  final O1Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter43 = 1043;
  final UrlO1 = 'gs://speakup-430fa.appspot.com/ض-الفتحة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
   ...
   SaveDataLetter43() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter43', 1043);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlo1 = UrlO1;
                          await O1Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B6-%D8%A7%D9%84%D9%81%D8%AA%D8%AD%D8%A9.mp3?alt=media&token=39e19f2e-8112-4d17-9445-f29f5e487988'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/ضَ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
