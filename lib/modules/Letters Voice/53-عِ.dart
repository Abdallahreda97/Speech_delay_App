...
class _r2State extends State<r2> {
  ...
  var SaveRoad;
  final R2Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter53 = 1053;
  final UrlR2 = 'gs://speakup-430fa.appspot.com/ع-الكسرة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
    ...
    SaveDataLetter53() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter53', 1053);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlr2 = UrlR2;
                          await R2Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B9-%D8%A7%D9%84%D9%83%D8%B3%D8%B1%D8%A9.mp3?alt=media&token=a270888e-c4ce-46f0-b5a7-baec8d60ef9f'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/عِ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
