...
class _v1State extends State<v1> {
  ...
  var SaveRoad;
  final V1Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter64 = 1064;
  final UrlV1 = 'gs://speakup-430fa.appspot.com/ك-الفتحة.mp3';
  // final EmailUser =
  ...
  SaveDataLetter64() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setInt('idLetter64', 1064);
    print("Success");
  }
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlv1 = UrlV1;
                          await V1Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%83-%D8%A7%D9%84%D9%81%D8%AA%D8%AD%D8%A9.mp3?alt=media&token=46f126f6-6581-4d01-8029-49bb5ed0ffaa'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/كَ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'ك');
