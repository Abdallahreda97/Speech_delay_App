...
class j2 extends StatefulWidget {
  const j2({Key? key}) : super(key: key);

  @override
  State<j2> createState() => _f3State();
}

class _f3State extends State<j2> {
  DateTime? _lastPressedAt;
  var SaveRoad;
  final J2Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  final UrlJ2 = 'gs://speakup-430fa.appspot.com/ر-الكسرة.mp3';
  int idLetter29 = 1029;
  // final EmailUser =
  ...
  Future initRecorder() async {
   ...
   SaveDataLetter29() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter29', 1029);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlj2 = UrlJ2;
                          await J2Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B1-%D8%A7%D9%84%D9%83%D8%B3%D8%B1%D8%A9.mp3?alt=media&token=9ce652e9-1a27-47c6-ad83-cf8e48057a20'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/رِ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'ر');
