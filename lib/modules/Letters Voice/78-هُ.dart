...
class z3 extends StatefulWidget {
  ...
  @override
  State<z3> createState() => _z3State();
}

class _z3State extends State<z3> {
  DateTime? _lastPressedAt;
  var SaveRoad;
  final Z3Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter78 = 1078;
  final UrlZ3 = 'gs://speakup-430fa.appspot.com/ه-الضمة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
    ...
    SaveDataLetter78() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter78', 1078);
      print("Success");
    }
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlz2 = UrlZ3;
                          await Z3Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%87-%D8%A7%D9%84%D8%B6%D9%85%D8%A9.mp3?alt=media&token=cec003ac-466d-4aa7-a68a-d8c2466524e7'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/هُ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
