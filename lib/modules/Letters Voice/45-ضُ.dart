...
class _o3State extends State<o3> {
  ...
  var SaveRoad;
  final O3Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter45 = 1045;
  final UrlO3 = 'gs://speakup-430fa.appspot.com/ض-الضمة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
   ...
   SaveDataLetter45() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter45', 1045);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlo3 = UrlO3;
                          await O3Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B6-%D8%A7%D9%84%D8%B6%D9%85%D8%A9.mp3?alt=media&token=ce5f8e42-e0c6-4e2d-9a2c-3526b3a6a30b'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/ضُ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
