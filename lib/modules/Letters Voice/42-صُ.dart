...
class n3 extends StatefulWidget {
  ...
  @override
  State<n3> createState() => _n3State();
}

class _n3State extends State<n3> {
  DateTime? _lastPressedAt;
  var SaveRoad;
  final N3Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter42 = 1042;
  final UrlN3 = 'gs://speakup-430fa.appspot.com/ص-الضمة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
   ...
   SaveDataLetter42() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter42', 1042);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urln3 = UrlN3;
                          await N3Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B5-%D8%A7%D9%84%D8%B6%D9%85%D8%A9.mp3?alt=media&token=4848f372-8c32-4507-ab77-94093d07cd03'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/صُ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
