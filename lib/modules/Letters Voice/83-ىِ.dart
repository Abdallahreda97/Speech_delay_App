...
class z35 extends StatefulWidget {
  const z35({Key? key}) : super(key: key);

  @override
  State<z35> createState() => _z35State();
}

class _z35State extends State<z35> {
  DateTime? _lastPressedAt;
  var SaveRoad;
  final Z35Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter83 = 1083;
  final UrlZ35 = 'gs://speakup-430fa.appspot.com/ي-الكسرة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
    ...
    SaveDataLetter83() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter83', 1083);
      print("Success");
    }
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlz35 = UrlZ35;
                          await Z35Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%8A-%D8%A7%D9%84%D9%83%D8%B3%D8%B1%D8%A9.mp3?alt=media&token=16e3a547-d967-49fd-b31f-21085b854f61'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/ىِ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'ي');
