...
class _r1State extends State<r1> {
  ...
  var SaveRoad;
  final R1Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter52 = 1052;
  final UrlR1 = 'gs://speakup-430fa.appspot.com/ع-الفتحة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
   ...
   SaveDataLetter52() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter52', 1052);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlr1 = UrlR1;
                          await R1Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B9-%D8%A7%D9%84%D9%81%D8%AA%D8%AD%D8%A9.mp3?alt=media&token=b1ca8ad9-2530-44ed-aeb9-315c7e47f1a9'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/عَ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'ع');
