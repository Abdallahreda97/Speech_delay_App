...
class _c2State extends State<c2> {
  ...
  var SaveRoad;
  final C2Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter8 = 1008;
  final UrlC2 = 'gs://speakup-430fa.appspot.com/ت-الكسرة.mp3';
  // final EmailUser =
  ...
  SaveDataLetter8() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter8', 1008);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlc2 = UrlC2;
                          await C2Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%AA-%D8%A7%D9%84%D9%83%D8%B3%D8%B1%D8%A9.mp3?alt=media&token=a9b8f27e-033b-4070-813c-c52d13f59f68'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/تِ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'تُِ');
