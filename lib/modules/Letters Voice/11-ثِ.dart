...
class _d2State extends State<d2> {
  ...
  var SaveRoad;
  final D2Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter11 = 1011;
  final UrlD2 = 'gs://speakup-430fa.appspot.com/ث-الكسرة.mp3';
  // final EmailUser =
  ...
  SaveDataLetter11() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter11', 1011);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urld2 = UrlD2;
                          await D2Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%AB-%D8%A7%D9%84%D9%83%D8%B3%D8%B1%D8%A9.mp3?alt=media&token=c8889b9c-7f25-43d4-a629-46db837a82da'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/ثِ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'ثُِ');
