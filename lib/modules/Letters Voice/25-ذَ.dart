...
class _i1State extends State<i1> {
  ...
  var SaveRoad;
  final I1Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter25 = 1025;
  final UrlI1 = 'gs://speakup-430fa.appspot.com/ذ-الفتحة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
   ...
   SaveDataLetter25() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter25', 1025);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urli1 = UrlI1;
                          await I1Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B0-%D8%A7%D9%84%D9%81%D8%AA%D8%AD%D8%A9.mp3?alt=media&token=c92b3a89-6fd2-4d0f-9072-bc92a64b57e8'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/ذَ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
