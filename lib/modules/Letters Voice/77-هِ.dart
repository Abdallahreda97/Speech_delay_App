...
class _z2State extends State<z2> {
  ...
  var SaveRoad;
  final Z2Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter77 = 1077;
  final UrlZ2 = 'gs://speakup-430fa.appspot.com/ه-الكسرة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
    ...
    SaveDataLetter77() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter77', 1077);
      print("Success");
    }
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlz2 = UrlZ2;
                          await Z2Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%87-%D8%A7%D9%84%D9%83%D8%B3%D8%B1%D8%A9.mp3?alt=media&token=bda582a6-ea4f-4149-bcad-410f208b6c8e'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/هِ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
