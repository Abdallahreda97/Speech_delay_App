...
class _l3State extends State<l3> {
  ...
  var SaveRoad;
  final L3Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  final UrlL3 = 'gs://speakup-430fa.appspot.com/س-الضمة.mp3';
  int idLetter36 = 1036;
  // final EmailUser =
  ...
  Future initRecorder() async {
   ...
   SaveDataLetter36() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter36', 1036);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urll3 = UrlL3;
                          await L3Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B3-%D8%A7%D9%84%D8%B6%D9%85%D8%A9.mp3?alt=media&token=85d4a952-c820-4866-924a-d0bff76953b7'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/سُ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
