...
class x1 extends StatefulWidget {
  const x1({Key? key}) : super(key: key);
...
class _x1State extends State<x1> {
  ...
  var SaveRoad;
  final X1Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter70 = 1070;
  final UrlX1 = 'gs://speakup-430fa.appspot.com/م-الفتحة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
    ...
    SaveDataLetter70() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter70', 1070);
      print("Success");
    }
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlx1 = UrlX1;
                          await X1Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%85-%D8%A7%D9%84%D9%81%D8%AA%D8%AD%D8%A9.mp3?alt=media&token=b73186f8-347b-48c1-b651-08099c012f34'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/مَ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
