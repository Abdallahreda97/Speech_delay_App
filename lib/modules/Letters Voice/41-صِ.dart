...
class n2 extends StatefulWidget {
  const n2({Key? key}) : super(key: key);

  @override
  State<n2> createState() => _n2State();
}

class _n2State extends State<n2> {
  DateTime? _lastPressedAt;
  var SaveRoad;
  final N2Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  final UrlN2 = 'gs://speakup-430fa.appspot.com/ص-الكسرة.mp3';
  int idLetter41 = 1041;
  // final EmailUser =
  ...
  Future initRecorder() async {
   ...
   SaveDataLetter41() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter41', 1041);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urln2 = UrlN2;
                          await N2Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B5-%D8%A7%D9%84%D9%83%D8%B3%D8%B1%D8%A9.mp3?alt=media&token=2d4c4337-d7bf-4bc7-9589-3d4af52f8c8a'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/صِ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'ص');
