...
class z36 extends StatefulWidget {
  const z36({Key? key}) : super(key: key);

  @override
  State<z36> createState() => _z36State();
}

class _z36State extends State<z36> {
  DateTime? _lastPressedAt;
  var SaveRoad;
  final Z36Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter84 = 1084;
  final UrlZ36 = 'gs://speakup-430fa.appspot.com/ي-الضمة.mp3';
  // final EmailUser =
  ...
  SaveDataLetter84() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setInt('idLetter84', 1084);
    print("Success");
  }
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlz36 = UrlZ36;
                          await Z36Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%8A-%D8%A7%D9%84%D8%B6%D9%85%D8%A9.mp3?alt=media&token=389553f9-9b00-495e-9c62-d88e8a6a5444'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/ىُ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
