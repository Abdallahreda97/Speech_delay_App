...
class y3 extends StatefulWidget {
  const y3({Key? key}) : super(key: key);

  @override
  State<y3> createState() => _y3State();
}

class _y3State extends State<y3> {
  DateTime? _lastPressedAt;
  var SaveRoad;
  final Y3Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  int idLetter75 = 1075;
  final UrlY3 = 'gs://speakup-430fa.appspot.com/ن-الضمة.mp3';
  // final EmailUser =
  ...
  Future initRecorder() async {
    ...
    SaveDataLetter75() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter75', 1075);
      print("Success");
    }
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urly3 = UrlY3;
                          await Y3Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%86-%D8%A7%D9%84%D8%B6%D9%85%D8%A9.mp3?alt=media&token=ebded350-26c0-4a47-8677-59460553f802'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/نُ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
