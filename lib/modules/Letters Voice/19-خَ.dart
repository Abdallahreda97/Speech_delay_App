...
class _g1State extends State<g1> {
  ...
  var SaveRoad;
  final G1Sound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  bool isRecorderReady = false;
  final UrlG1 = 'gs://speakup-430fa.appspot.com/خ-الفتحة.mp3';
  int idLetter19 = 1019;
  final EmailUser =
  ...
  Future initRecorder() async {
   ...
   SaveDataLetter19() async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('idLetter19', 1019);
      print("Success");
    }
  @override
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlg1 = UrlG1;
                          await G1Sound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%AE-%D8%A7%D9%84%D9%81%D8%AA%D8%AD%D8%A9.mp3?alt=media&token=4e16e36a-9e6a-46df-9c04-519a60011dc5'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/خَ.jpeg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_char(className: 'خَُ');
