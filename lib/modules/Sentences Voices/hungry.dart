...
class hungry extends StatefulWidget {
  const hungry({Key? key}) : super(key: key);

  @override
  State<hungry> createState() => _cat1State();
}

class _cat1State extends State<hungry> {
  int idSen1 = 200;
  double confidenceLevel = 0.0;
  SoundModel soundModel = SoundModel();
  bool _isLoading = false;
  final audioFile = 'SavingAudios.aac';
  final HungrySound = AudioPlayer();
  final UrlHY1 = 'gs://speakup-430fa.appspot.com/انا جعان.mp3'; // file location
  // final EmailUser =
...
// animation
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlhy1 = UrlHY1;
                          await HungrySound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A7%D9%86%D8%A7%20%D8%AC%D8%B9%D8%A7%D9%86.mp3?alt=media&token=dc354bb4-1c80-4938-885b-4184c3700e67'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/أنا جعان.jpg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_phrase(className: 'انا جعان');
