...
import 'im_thirsty.dart';

class im_sorry extends StatefulWidget {
  const im_sorry({Key? key}) : super(key: key);

  @override
  State<im_sorry> createState() => _im_sorryState();
}

class _im_sorryState extends State<im_sorry> {
  int idSen14 = 213;
  double confidenceLevel = 0.0;
  SoundModel soundModel = SoundModel();
  bool _isLoading = false;
  final audioFile = 'SavingAudios.aac';
  final ISoorySound = AudioPlayer();
  final UrlIS3 = 'gs://speakup-430fa.appspot.com/انا اسف.mp3'; // file location
  // final EmailUser =
...
// animation
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlis3 = UrlIS3;
                          await ISoorySound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A7%D9%86%D8%A7%20%D8%A7%D8%B3%D9%81.mp3?alt=media&token=de4e3e4d-0f5f-4048-a826-24ae6cd681cf'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/أنا اسف.jpg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_phrase(className: 'انا اسف');
