...
class _loveState extends State<love> {
  ...
  final ILoveSound = AudioPlayer();
  final UrlIL1 = 'gs://speakup-430fa.appspot.com/انا بحب.mp3'; // file location
  // final EmailUser =
...
// animation
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlil1 = UrlIL1;
                          await ILoveSound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A7%D9%86%D8%A7%20%D8%A8%D8%AD%D8%A8.mp3?alt=media&token=a72b2b32-a220-4ada-aa36-40373b105463'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/أنا بحب.jpg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_phrase(className: 'انا بحب');
