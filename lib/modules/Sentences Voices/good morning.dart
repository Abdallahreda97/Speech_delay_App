...
import 'good evening.dart';

class good_morning extends StatefulWidget {
  const good_morning({Key? key}) : super(key: key);
...
class _good_morningState extends State<good_morning> {
  ...
  final GoodMorringSound = AudioPlayer();
  final UrlGM1 = 'gs://speakup-430fa.appspot.com/صباح الخير.mp3'; // file location
  // final EmailUser =
...
// animation
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlgm1 = UrlGM1;
                          await GoodMorringSound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B5%D8%A8%D8%A7%D8%AD%20%D8%A7%D9%84%D8%AE%D9%8A%D8%B1.mp3?alt=media&token=17a33435-b575-489d-a149-befc9b01582b'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/صباح الخير.jpg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_phrase(className: 'صباح الخير');
