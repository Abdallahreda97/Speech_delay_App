...
class how_ara_you extends StatefulWidget {
  const how_ara_you({Key? key}) : super(key: key);

  @override
  State<how_ara_you> createState() => _how_ara_youState();
}

class _how_ara_youState extends State<how_ara_you> {
  int idSen6 = 205;
  double confidenceLevel = 0.0;
  SoundModel soundModel = SoundModel();
  bool _isLoading = false;
  final audioFile = 'SavingAudios.aac';
  final HowSound = AudioPlayer();
  final UrlHO1 = 'gs://speakup-430fa.appspot.com/كيف حالك.mp3'; // file location
  // final EmailUser =
...
// animation
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlho1 = UrlHO1;
                          await HowSound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%83%D9%8A%D9%81%20%D8%AD%D8%A7%D9%84%D9%83.mp3?alt=media&token=71cc3606-a934-4e16-b13c-900421e5c8e1'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/كيف حالك.jpg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_phrase(className: 'كيف حالك');
