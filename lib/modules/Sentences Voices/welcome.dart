...
class _welcomeState extends State<welcome> {
  ...
  int idSen5 = 204;
  final WelcomeSound = AudioPlayer();
  final UrlWS1 = 'gs://speakup-430fa.appspot.com/اهلا وسهلا.mp3'; // file location
  // final EmailUser =
...
// animation
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlws1 = UrlWS1;
                          await WelcomeSound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A7%D9%87%D9%84%D8%A7%20%D9%88%D8%B3%D9%87%D9%84%D8%A7.mp3?alt=media&token=401467d2-e55c-4b0e-8775-80bb13fc1667'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/أهلا و سهلا.gif"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_phrase(className: 'اهلا وسهلا');
