...
import 'i_want_to_play.dart';

class i_want_to_go_out extends StatefulWidget {
  const i_want_to_go_out({Key? key}) : super(key: key);

  @override
  State<i_want_to_go_out> createState() => _i_want_to_go_outState();
}

class _i_want_to_go_outState extends State<i_want_to_go_out> {
  int idSen8 = 207;
  double confidenceLevel = 0.0;
  SoundModel soundModel = SoundModel();
  bool _isLoading = false;
  final audioFile = 'SavingAudios.aac';
  final GoOutSound = AudioPlayer();
  final UrlGO1 = 'gs://speakup-430fa.appspot.com/عايز اخرج.mp3'; // file location
  // final EmailUser =
...
// animation
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlgo1 = UrlGO1;
                          await GoOutSound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B9%D8%A7%D9%8A%D8%B2%20%D8%A7%D8%AE%D8%B1%D8%AC.mp3?alt=media&token=2a4a2b78-4059-446a-9d94-831c3f3d3c83'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/عايز اخرج.jpg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_phrase(className: 'عايز اخرج');
