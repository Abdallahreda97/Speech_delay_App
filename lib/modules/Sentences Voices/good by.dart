...
import 'good morning.dart';

class good_by extends StatefulWidget {
  const good_by({Key? key}) : super(key: key);

  @override
  State<good_by> createState() => _good_byState();
}

class _good_byState extends State<good_by> {
  int idSen2 = 201;
  double confidenceLevel = 0.0;
  SoundModel soundModel = SoundModel();
  bool _isLoading = false;
  final audioFile = 'SavingAudios.aac';
  final GoodBySound = AudioPlayer();
  final UrlGB1 = 'gs://speakup-430fa.appspot.com/مع السلامة.mp3'; // file location
  // final EmailUser =
...
// animation
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlgb1 = UrlGB1;
                          await GoodBySound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%85%D8%B9%20%D8%A7%D9%84%D8%B3%D9%84%D8%A7%D9%85%D8%A9.mp3?alt=media&token=cd9d421b-24b3-49a7-842d-ff91c322b2dc'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/مع السلامة.gif"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_phrase(className: 'مع السلامه');
