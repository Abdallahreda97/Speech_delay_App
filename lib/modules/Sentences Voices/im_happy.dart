...
class im_happy extends StatefulWidget {
  const im_happy({Key? key}) : super(key: key);

  @override
  State<im_happy> createState() => _im_happyState();
}

class _im_happyState extends State<im_happy> {
  int idSen12 = 211;
  double confidenceLevel = 0.0;
  SoundModel soundModel = SoundModel();
  bool _isLoading = false;
  final audioFile = 'SavingAudios.aac';
  final IHappySound = AudioPlayer();
  final UrlIH1 = 'gs://speakup-430fa.appspot.com/انا فرحان.mp3'; // file location
  // final EmailUser =
...
// animation
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlih1 = UrlIH1;
                          await IHappySound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A7%D9%86%D8%A7%20%D9%81%D8%B1%D8%AD%D8%A7%D9%86.mp3?alt=media&token=df617451-f929-40bb-a1b2-c4895183a5c9'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/أنا فرحان.jpg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_phrase(className: 'انا فرحان');
