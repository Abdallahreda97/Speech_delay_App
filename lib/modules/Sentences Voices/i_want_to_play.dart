...
import 'im_sleepy.dart';

class i_want_to_play extends StatefulWidget {
  const i_want_to_play({Key? key}) : super(key: key);

  @override
  State<i_want_to_play> createState() => _i_want_to_playState();
}

class _i_want_to_playState extends State<i_want_to_play> {
  int idSen9 = 208;
  double confidenceLevel = 0.0;
  SoundModel soundModel = SoundModel();
  bool _isLoading = false;
  final audioFile = 'SavingAudios.aac';
  final IPlaySound = AudioPlayer();
  final UrlIP1 = 'gs://speakup-430fa.appspot.com/عايز العب.mp3'; // file location
  // final EmailUser =
...
// animation
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlip1 = UrlIP1;
                          await IPlaySound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B9%D8%A7%D9%8A%D8%B2%20%D8%A7%D9%84%D8%B9%D8%A8.mp3?alt=media&token=03b5adf0-f8d2-4da7-bc03-ce478baa3515'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/عايز العب.jpg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_phrase(className: 'عايز العب');
