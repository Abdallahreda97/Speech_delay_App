...
class im_sleepy extends StatefulWidget {
  const im_sleepy({Key? key}) : super(key: key);

  @override
  State<im_sleepy> createState() => _im_sleepyState();
}

class _im_sleepyState extends State<im_sleepy> {
  int idSen10 = 209;
  double confidenceLevel = 0.0;
  SoundModel soundModel = SoundModel();
  bool _isLoading = false;
  final audioFile = 'SavingAudios.aac';
  final ISleepySound = AudioPlayer();
  final UrlIS2 = 'gs://speakup-430fa.appspot.com/انا نعسان.mp3'; // file location
  // final EmailUser =
...
// animation
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var Urlis2 = UrlIS2;
                          await ISleepySound.play(UrlSource(
                              'https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A7%D9%86%D8%A7%20%D9%86%D8%B9%D8%B3%D8%A7%D9%86.mp3?alt=media&token=db62ba89-25c7-42eb-ab10-418e5180a48d'));
                        }),
                      ),
                    ),
                    Bounce(
                      ...
                      child: Container(
                          child: Image(
                              height: 350,
                              image: AssetImage("images/أنا نعسان.jpg"))),
                    ),
                    SizedBox(
                      height: 15,
                    ),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_phrase(className: 'انا نعسان');
