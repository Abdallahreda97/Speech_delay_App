...
class _openState extends State<open> {
  ...
  final OpenSound = AudioPlayer();
  final urlLE3 = "gs://speakup-430fa.appspot.com/فتح.mp3";
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var urle3 = urlLE3;
                          await OpenSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%81%D8%AA%D8%AD.mp3?alt=media&token=bf5d0cfb-fd01-48c6-93b4-e1fbea9b703a"));
                        }),
                      ),
                    ),
                    Bounce(
                        ...
                        child: Container(
                            child: Image(
                                height: 350,
                                image: AssetImage("images/فتح.jpg"))),
                        onPressed: (() async {
                          var urlle3 = urlLE3;
                          await OpenSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%81%D8%AA%D8%AD.mp3?alt=media&token=bf5d0cfb-fd01-48c6-93b4-e1fbea9b703a"));
                        })),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_command(className:'فتح');
