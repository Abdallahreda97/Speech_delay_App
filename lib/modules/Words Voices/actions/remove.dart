...
class _removeState extends State<remove> {
  ...
  final RemoveSound = AudioPlayer();
  final urlLE5 = "gs://speakup-430fa.appspot.com/الغاء.mp3";
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var urlle5 = urlLE5;
                          await RemoveSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A7%D9%84%D8%BA%D8%A7%D8%A1.mp3?alt=media&token=6e34b0ba-3f9e-4e1a-a03f-d3c218cf394e"));
                        }),
                      ),
                    ),
                    Bounce(
                        ...
                        child: Container(
                            child: Image(
                                height: 350,
                                image: AssetImage("images/الغاء.webp"))),
                        onPressed: (() async {
                          var urlle5 = urlLE5;
                          await RemoveSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A7%D9%84%D8%BA%D8%A7%D8%A1.mp3?alt=media&token=6e34b0ba-3f9e-4e1a-a03f-d3c218cf394e"));
                        })),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_command(className: 'الغاء');
