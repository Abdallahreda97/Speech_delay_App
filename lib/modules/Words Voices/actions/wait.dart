...
class _waitState extends State<wait> {
  ...
  final WaitSound = AudioPlayer();
  final urlLE8 = "gs://speakup-430fa.appspot.com/تعطيل.mp3";
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var urlle8 = urlLE8;
                          await WaitSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%AA%D8%B9%D8%B7%D9%8A%D9%84.mp3?alt=media&token=1199b304-3088-49ed-98ed-0afc600cb949"));
                        }),
                      ),
                    ),
                    Bounce(
                        ...
                        child: Container(
                            child: Image(
                                height: 350,
                                image: AssetImage("images/تعطيل.jpg"))),
                        onPressed: (() async {
                          var urlle8 = urlLE8;
                          await WaitSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%AA%D8%B9%D8%B7%D9%8A%D9%84.mp3?alt=media&token=1199b304-3088-49ed-98ed-0afc600cb949"));
                        })),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_command(className: 'تعطيل');
