...
class _closeState extends State<close> {
  ...
  final Closesound = AudioPlayer();
  final UrlLE1 = "gs://speakup-430fa.appspot.com/اغلاق.mp3";
                      ...
                      children: [
                        Container(
                          ...
                          child: ListTile(
                            ...
                            onTap: (() async {
                              var urlle1 = UrlLE1;
                              await Closesound.play(UrlSource(
                                  "https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A7%D8%BA%D9%84%D8%A7%D9%82.mp3?alt=media&token=ffc866ec-dce7-487e-bdf2-9feefe92e09b"));
                            }),
                          ),
                        ),
                        Bounce(
                            ...
                            child: Container(
                                child: Image(
                                    height: 350,
                                    image: AssetImage("images/إغلاق.png"))),
                            onPressed: (() async {
                              var urlle1 = UrlLE1;
                              await Closesound.play(UrlSource(
                                  "https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A7%D8%BA%D9%84%D8%A7%D9%82.mp3?alt=media&token=ffc866ec-dce7-487e-bdf2-9feefe92e09b"));
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_command(className: 'اغلاق');
