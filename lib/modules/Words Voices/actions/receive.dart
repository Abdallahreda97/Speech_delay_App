...
class _receiveState extends State<receive> {
  ...
  final ReceiveSound = AudioPlayer();
  final urlLE4 = "gs://speakup-430fa.appspot.com/استقبال.mp3";
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var urlle4 = urlLE4;
                          await ReceiveSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A7%D8%B3%D8%AA%D9%82%D8%A8%D8%A7%D9%84.mp3?alt=media&token=6bd908f9-f5f2-41a4-ae99-0a05a4fd9573"));
                        }),
                      ),
                    ),
                    Bounce(
                        ...
                        child: Container(
                            child: Image(
                                height: 350,
                                image: AssetImage("images/استقبال.jpg"))),
                        onPressed: (() async {
                          var urlle4 = urlLE4;
                          await ReceiveSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A7%D8%B3%D8%AA%D9%82%D8%A8%D8%A7%D9%84.mp3?alt=media&token=6bd908f9-f5f2-41a4-ae99-0a05a4fd9573"));
                        })),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_command(className: 'استقبال');
