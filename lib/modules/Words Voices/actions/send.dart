...
class _sendState extends State<send> {
  ...
  final SendSound = AudioPlayer();
  final urlLE6 = "gs://speakup-430fa.appspot.com/ارسال.mp3";
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var urlle6 = urlLE6;
                          await SendSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A7%D8%B1%D8%B3%D8%A7%D9%84.mp3?alt=media&token=8bca2379-6efb-4d45-be80-cafafeb041e5"));
                        }),
                      ),
                    ),
                    Bounce(
                        ...
                        child: Container(
                            child: Image(
                                height: 350,
                                image: AssetImage("images/ارسال.jfif"))),
                        onPressed: (() async {
                          var urlle6 = urlLE6;
                          await SendSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A7%D8%B1%D8%B3%D8%A7%D9%84.mp3?alt=media&token=8bca2379-6efb-4d45-be80-cafafeb041e5"));
                        })),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_command(className: 'ارسال');
