...
class _startState extends State<start> {
  ...
  final StartSound = AudioPlayer();
  final urlLE7 = "gs://speakup-430fa.appspot.com/ابدا.mp3";
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var urlle7 = urlLE7;
                          await StartSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A7%D8%A8%D8%AF%D8%A7.mp3?alt=media&token=96c45626-bf4d-48e7-b4dd-080b8b993fbf"));
                        }),
                      ),
                    ),
                    Bounce(
                        ...
                        child: Container(
                            child: Image(
                                height: 350,
                                image: AssetImage("images/ابدا.png"))),
                        onPressed: (() async {
                          var urlle7 = urlLE7;
                          await StartSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A7%D8%A8%D8%AF%D8%A7.mp3?alt=media&token=96c45626-bf4d-48e7-b4dd-080b8b993fbf"));
                        })),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_command(className: 'ابدا');
