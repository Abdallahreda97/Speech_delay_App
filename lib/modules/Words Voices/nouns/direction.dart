...
class _directionState extends State<direction> {
  ...
  final DirectionSound = AudioPlayer();
  final urlLE19 = "gs://speakup-430fa.appspot.com/اتجاه.mp3";
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var urlle19 = urlLE19;
                          await DirectionSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A7%D8%AA%D8%AC%D8%A7%D9%87.mp3?alt=media&token=4f1bdff1-352c-4d49-8be1-923b7b862c32"));
                        }),
                      ),
                    ),
                    Bounce(
                        ...
                        child: Container(
                            child: Image(
                                height: 350,
                                image: AssetImage("images/اتجاه.png"))),
                        onPressed: (() async {
                          var urlle19 = urlLE19;
                          await DirectionSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A7%D8%AA%D8%AC%D8%A7%D9%87.mp3?alt=media&token=4f1bdff1-352c-4d49-8be1-923b7b862c32"));
                        })),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_command(className:'اتجاه');
