...
class _eyeState extends State<eye> {
  ...
  final EyeSound = AudioPlayer();
  final urlLE20 = "gs://speakup-430fa.appspot.com/عين.mp3";
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var urlle20 = urlLE20;
                          await EyeSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B9%D9%8A%D9%86.mp3?alt=media&token=d26d049b-9384-4a67-92a9-1b2c878fbf5f"));
                        }),
                      ),
                    ),
                    Bounce(
                        ...
                        child: Container(
                            child: Image(
                                height: 350,
                                image: AssetImage("images/عين.png"))),
                        onPressed: (() async {
                           var urlle20 = urlLE20;
                           await EyeSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B9%D9%8A%D9%86.mp3?alt=media&token=d26d049b-9384-4a67-92a9-1b2c878fbf5f"));
                        })),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_command(className:'عين');
