...
class _nextState extends State<next> {
  ...
  final NextSound = AudioPlayer();
  final urlLE21 = "gs://speakup-430fa.appspot.com/التالي.mp3";
  // final EmailUser =
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var urlle21 = urlLE21;
                          await NextSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A7%D9%84%D8%AA%D8%A7%D9%84%D9%8A.mp3?alt=media&token=253acfff-9d6a-4879-971c-84360ee4d307"));
                        }),
                      ),
                    ),
                    Bounce(
                        ...
                        child: Container(
                            child: Image(
                                height: 350,
                                image: AssetImage("images/التالى.png"))),
                        onPressed: (() async {
                          var urlle21 = urlLE21;
                          await NextSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A7%D9%84%D8%AA%D8%A7%D9%84%D9%8A.mp3?alt=media&token=253acfff-9d6a-4879-971c-84360ee4d307"));
                        })),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_command(className:'التالي');
