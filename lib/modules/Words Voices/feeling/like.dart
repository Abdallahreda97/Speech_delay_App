...
class _likeState extends State<like> {
  ...
  final LikeSound = AudioPlayer();
  final urlLE15 = "gs://speakup-430fa.appspot.com/اعجبني.mp3";
                      ...
                      children: [
                        Container(
                          ...
                          child: ListTile(
                            ...
                            onTap: (() async {
                              var urlle15 = urlLE15;
                              await LikeSound.play(UrlSource(
                                  "https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A7%D8%B9%D8%AC%D8%A8%D9%86%D9%8A.mp3?alt=media&token=6337fcec-b543-40ad-9b16-b0084e28b329"));
                            }),
                          ),
                        ),
                        Bounce(
                            ...
                            child: Container(
                                child: Image(
                                    height: 350,
                                    image: AssetImage("images/أعجبنى.jpg"))),
                            onPressed: (() async {
                              var urlle15 = urlLE15;
                              await LikeSound.play(UrlSource(
                                  "https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A7%D8%B9%D8%AC%D8%A8%D9%86%D9%8A.mp3?alt=media&token=6337fcec-b543-40ad-9b16-b0084e28b329"));
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_vocal(className: 'يعجبني');
