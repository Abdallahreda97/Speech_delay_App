...
class _badState extends State<bad> {
  ...
  final BadSound = AudioPlayer();
  final urlLE11 = "gs://speakup-430fa.appspot.com/سي.mp3";
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var urlle11 = urlLE11;
                          await BadSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B3%D9%8A.mp3?alt=media&token=9b94099c-1c3e-47a1-a940-c4bc044b1ad4"));
                        }),
                      ),
                    ),
                    Bounce(
                        ...
                        child: Container(
                            child: Image(
                                height: 350,
                                image: AssetImage("images/سئ.jpg"))),
                        onPressed: (() async {
                          var urlle11 = urlLE11;
                          await BadSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B3%D9%8A.mp3?alt=media&token=9b94099c-1c3e-47a1-a940-c4bc044b1ad4"));
                        })),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_vocal(className: 'سي');
