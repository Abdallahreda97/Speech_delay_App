...
class _filmState extends State<film> {
  ...
  final FilmSound = AudioPlayer();
  final urlLE14 = "gs://speakup-430fa.appspot.com/الفليم.mp3";
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var urlle14 = urlLE14;
                          await FilmSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A7%D9%84%D9%81%D9%84%D9%8A%D9%85.mp3?alt=media&token=f238d25b-c01b-41de-8777-df97f094db98"));
                        }),
                      ),
                    ),
                    Bounce(
                        ...
                        child: Container(
                            child: Image(
                                height: 350,
                                image: AssetImage("images/الفيلم.jpg"))),
                        onPressed: (() async {
                          var urlle14 = urlLE14;
                          await FilmSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%A7%D9%84%D9%81%D9%84%D9%8A%D9%85.mp3?alt=media&token=f238d25b-c01b-41de-8777-df97f094db98"));
                        })),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_vocal(className: 'فليم');
