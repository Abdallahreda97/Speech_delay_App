...
class _agreeState extends State<agree> {
  ...
  final AgreeSound = AudioPlayer();
  final urlLE9 = "gs://speakup-430fa.appspot.com/موافق.mp3";
  // final EmailUser =
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var urlle9 = urlLE9;
                          await AgreeSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%85%D9%88%D8%A7%D9%81%D9%82.mp3?alt=media&token=f6f1be21-7e23-496a-ba60-c9596c96ea13"));
                        }),
                      ),
                    ),
                    Bounce(
                        ...
                        child: Container(
                            child: Image(
                                height: 350,
                                image: AssetImage("images/موافق.png"))),
                        onPressed: (() async {
                          var urlle9 = urlLE9;
                          await AgreeSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%85%D9%88%D8%A7%D9%81%D9%82.mp3?alt=media&token=f6f1be21-7e23-496a-ba60-c9596c96ea13"));
                        })),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_vocal(className: 'موافق');
