...
class _noState extends State<no> {
  ...
  final NoSound = AudioPlayer();
  final urlLE16 = "gs://speakup-430fa.appspot.com/لا.mp3";
  // final EmailUser =
                      ...
                      children: [
                        Container(
                          ...
                          child: ListTile(
                            ...
                            onTap: (() async {
                              var urlle16 = urlLE16;
                              await NoSound.play(UrlSource(
                                  "https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%84%D8%A7.mp3?alt=media&token=86516455-2615-4682-aec6-b2c30145b81f"));
                            }),
                          ),
                        ),
                        Bounce(
                            ...
                            child: Container(
                                child: Image(
                                    height: 350,
                                    image: AssetImage("images/لا.png"))),
                            onPressed: (() async {
                              var urlle16 = urlLE16;
                              await NoSound.play(UrlSource(
                                  "https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%84%D8%A7.mp3?alt=media&token=86516455-2615-4682-aec6-b2c30145b81f"));
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_vocal(className: 'لا');
