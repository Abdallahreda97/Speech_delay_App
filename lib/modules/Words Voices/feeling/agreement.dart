...
class _agreementState extends State<agreement> {
  ...
  final AgreementSound = AudioPlayer();
  final urlLE10 = "gs://speakup-430fa.appspot.com/مقبول.mp3";
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var urlle10 = urlLE10;
                          await AgreementSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%85%D9%82%D8%A8%D9%88%D9%84.mp3?alt=media&token=49688e23-9747-4d09-a7ed-37d06b35436a"));
                        }),
                      ),
                    ),
                    Bounce(
                        ...
                        child: Container(
                            child: Image(
                                height: 350,
                                image: AssetImage("images/مقبول.jpg"))),
                        onPressed: (() async {
                          var urlle10 = urlLE10;
                          await AgreementSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%85%D9%82%D8%A8%D9%88%D9%84.mp3?alt=media&token=49688e23-9747-4d09-a7ed-37d06b35436a"));
                        })),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_vocal(className: 'مقبول');
