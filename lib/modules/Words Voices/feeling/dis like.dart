...
class dis_like extends StatefulWidget {
  const dis_like({Key? key}) : super(key: key);

  @override
  State<dis_like> createState() => _dis_likeState();
}

class _dis_likeState extends State<dis_like> {
  ...
  final DislikeSound = AudioPlayer();
  final urlLE12 = "gs://speakup-430fa.appspot.com/لم يعحبني.mp3";
  // final EmailUser =
                      ...
                      children: [
                        Container(
                          ...
                          child: ListTile(
                            ...
                            onTap: (() async {
                              var urlle12 = urlLE12;
                              await DislikeSound.play(UrlSource(
                                  "https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%84%D9%85%20%D9%8A%D8%B9%D8%AD%D8%A8%D9%86%D9%8A.mp3?alt=media&token=699e0468-88c3-4f27-a5ab-f673ecaf8f04"));
                            }),
                          ),
                        ),
                        Bounce(
                            ...
                            child: Container(
                                child: Image(
                                    height: 350,
                                    image: AssetImage("images/لم يعجبنى.jpg"))),
                            onPressed: (() async {
                              var urlle12 = urlLE12;
                              await DislikeSound.play(UrlSource(
                                  "https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%84%D9%85%20%D9%8A%D8%B9%D8%AD%D8%A8%D9%86%D9%8A.mp3?alt=media&token=699e0468-88c3-4f27-a5ab-f673ecaf8f04"));
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_vocal(className: 'لم يعجبني');
