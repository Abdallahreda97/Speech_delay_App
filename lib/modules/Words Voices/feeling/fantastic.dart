...
import '../../../calssifiers/SoundClassifier.dart';import '../../../models/SoundModel.dart';

import 'film.dart';

class fantastic extends StatefulWidget {
  const fantastic({Key? key}) : super(key: key);
...
class _fantasticState extends State<fantastic> {
  ...
  final FantasticSound = AudioPlayer();
  final urlLE13 = "gs://speakup-430fa.appspot.com/رائع.mp3";
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var urlle13 = urlLE13;
                          await FantasticSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B1%D8%A7%D8%A6%D8%B9.mp3?alt=media&token=c0107ec7-c218-41e1-8d64-d58e346e5522"));
                        }),
                      ),
                    ),
                    Bounce(
                        ...
                        child: Container(
                            child: Image(
                                height: 350,
                                image: AssetImage("images/رائع.gif"))),
                        onPressed: (() async {
                          var urlle13 = urlLE13;
                          await FantasticSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B1%D8%A7%D8%A6%D8%B9.mp3?alt=media&token=c0107ec7-c218-41e1-8d64-d58e346e5522"));
                        })),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_vocal(className: 'رائع');
    if (result < 50) {
