...
class _yesState extends State<yes> {
  ...
  final YesSound = AudioPlayer();
  final urlLE18 = "gs://speakup-430fa.appspot.com/نعم.mp3";
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var urlle18 = urlLE18;
                          await YesSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%86%D8%B9%D9%85.mp3?alt=media&token=31aa405a-0d62-4573-af7f-e37fb0686a6c"));
                        }),
                      ),
                    ),
                    Bounce(
                        ...
                        child: Container(
                            child: Image(
                                height: 350,
                                image: AssetImage("images/نعم.png"))),
                        onPressed: (() async {
                          var urlle18 = urlLE18;
                          await YesSound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D9%86%D8%B9%D9%85.mp3?alt=media&token=31aa405a-0d62-4573-af7f-e37fb0686a6c"));
                        })),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_vocal(className: 'نعم');
