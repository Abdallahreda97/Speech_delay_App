...
class _number1State extends State<number1> {
  ...
  final Num1Sound = AudioPlayer();
  final urlNM1 = "gs://speakup-430fa.appspot.com/1.mp3";
                      ...
                      children: [
                        Container(
                          ...
                          child: ListTile(
                            ...
                            onTap: (() async {
                              var urlnm1 = urlNM1;
                              await Num1Sound.play(UrlSource(
                                  "https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/1.mp3?alt=media&token=cc190cd2-8d36-4c70-86c6-7df4fc1b5c90"));
                            }),
                          ),
                        ),
                        Bounce(
                            ...
                            child: Container(
                                child: Image(
                                    height: 350,
                                    image: AssetImage("images/1برتقالى.png"))),
                            onPressed: (() async {
                              var urlnm1 = urlNM1;
                              await Num1Sound.play(UrlSource(
                                  "https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/1.mp3?alt=media&token=cc190cd2-8d36-4c70-86c6-7df4fc1b5c90"));
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_command(className: 'واحد');
