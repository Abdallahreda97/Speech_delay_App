...
class _number7State extends State<number7> {
  ...
  final Num7Sound = AudioPlayer();
  final urlNM7 = "gs://speakup-430fa.appspot.com/7.mp3";
  // final EmailUser =
                      ...
                      children: [
                        Container(
                          ...
                          child: ListTile(
                            ...
                            onTap: (() async {
                              var urlnm7 = urlNM7;
                              await Num7Sound.play(UrlSource(
                                  "https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/7.mp3?alt=media&token=a5197c38-e558-4748-b56f-45d200f46c83"));
                            }),
                          ),
                        ),
                        Bounce(
                            ...
                            child: Container(
                                child: Image(
                                    height: 350,
                                    image: AssetImage("images/7برتقالى.png"))),
                            onPressed: (() async {
                              var urlnm7 = urlNM7;
                              await Num7Sound.play(UrlSource(
                                  "https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/7.mp3?alt=media&token=a5197c38-e558-4748-b56f-45d200f46c83"));
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_command(className: 'سبعه');
