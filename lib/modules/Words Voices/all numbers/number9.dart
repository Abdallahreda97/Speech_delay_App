...
class number9 extends StatefulWidget {
  const number9({Key? key}) : super(key: key);
...
class _number9State extends State<number9> {
  ...
  final Num9Sound = AudioPlayer();
  final urlNM9 = "gs://speakup-430fa.appspot.com/9.dat.mp3";
  // final EmailUser =
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var urlnm9 = urlNM9;
                          await Num9Sound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/9.dat.mp3?alt=media&token=ce5b8d5d-184d-4936-8594-158f9c6deeae"));
                        }),
                      ),
                    ),
                    Bounce(
                        ...
                        child: Container(
                            child: Image(
                                height: 350,
                                image: AssetImage("images/9برتقالى.png"))),
                        onPressed: (() async {
                          var urlnm9 = urlNM9;
                          await Num9Sound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/9.dat.mp3?alt=media&token=ce5b8d5d-184d-4936-8594-158f9c6deeae"));
                        })),
...
Future<bool> _onWillPop() async {
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_command(className: 'تسعه');
