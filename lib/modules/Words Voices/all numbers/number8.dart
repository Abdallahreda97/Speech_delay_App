...
class _number8State extends State<number8> {
  ...
  final Num8Sound = AudioPlayer();
  final urlNM8 = "gs://speakup-430fa.appspot.com/8.mp3";
  // final EmailUser =
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var urlnm8 = urlNM8;
                          await Num8Sound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/8.mp3?alt=media&token=52835763-40d3-4bfd-b144-7408a1b2b82b"));
                        }),
                      ),
                    ),
                    Bounce(
                      duration: Duration(milliseconds: 110),
                        child: Container(
                            child: Image(
                                height: 350,
                                image: AssetImage("images/8برتقالى.png"))),
                        onPressed: (() async {
                          var urlnm8 = urlNM8;
                          await Num8Sound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/8.mp3?alt=media&token=52835763-40d3-4bfd-b144-7408a1b2b82b"));
                        })),
...
Future<bool> _onWillPop() async {
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_command(className: 'ثمانيه');
