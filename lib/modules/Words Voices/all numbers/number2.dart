...
class _number2State extends State<number2> {
  ...
  final Num2Sound = AudioPlayer();
  final urlNM2 = "gs://speakup-430fa.appspot.com/2.mp3";
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var urlnm2 = urlNM2;
                          await Num2Sound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/2.mp3?alt=media&token=b8dd94b2-1f31-40a1-b831-6c0a460e9bd6"));
                        }),
                      ),
                    ),
                    Bounce(
                      duration: Duration(milliseconds: 110),
                        child: Container(
                            child: Image(
                                height: 350,
                                image: AssetImage("images/2برتقالى.png"))),
                        onPressed: (() async {
                          var urlnm2 = urlNM2;
                          await Num2Sound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/2.mp3?alt=media&token=b8dd94b2-1f31-40a1-b831-6c0a460e9bd6"));
                        })),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_command(className: 'اثنين');
