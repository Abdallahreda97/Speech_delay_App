...
class _number3State extends State<number3> {
  ...
  final Num3Sound = AudioPlayer();
  final urlNM3 = "gs://speakup-430fa.appspot.com/3.mp3";
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var urlnm3 = urlNM3;
                          await Num3Sound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/3.mp3?alt=media&token=4aea45d2-4b0d-41eb-be70-6bc961d169ad"));
                        }),
                      ),
                    ),
                    Bounce(
                      duration: Duration(milliseconds: 110),
                        child: Container(
                            child: Image(
                                height: 350,
                                image: AssetImage("images/3برتقالى.png"))),
                        onPressed: (() async {
                          var urlnm3 = urlNM3;
                          await Num3Sound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/3.mp3?alt=media&token=4aea45d2-4b0d-41eb-be70-6bc961d169ad"));
                        })),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_command(className: 'ثلاثه');
