...
class _number5State extends State<number5> {
  ...
  final Num5Sound = AudioPlayer();
  final urlNM5 = "gs://speakup-430fa.appspot.com/5.mp3";
  // final EmailUser =
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var urlnm5 = urlNM5;
                          await Num5Sound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/5.mp3?alt=media&token=dbeacc8d-3fb7-415f-b8ea-025ebaee8b5b"));
                        }),
                      ),
                    ),
                    Bounce(
                        ...
                        child: Container(
                            child: Image(
                                height: 350,
                                image: AssetImage("images/5برتقالى.png"))),
                        onPressed: (() async {
                          var urlnm5 = urlNM5;
                          await Num5Sound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/5.mp3?alt=media&token=dbeacc8d-3fb7-415f-b8ea-025ebaee8b5b"));
                        })),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_command(className: 'خمسه');
