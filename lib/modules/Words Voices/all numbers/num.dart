...
import '../nouns/direction.dart';

class numm extends StatefulWidget {
  const numm({Key? key}) : super(key: key);

  @override
  State<numm> createState() => _nummState();
}

class _nummState extends State<numm> {
  DateTime? _lastPressedAt;

  //final ASound = AudioPlayer();
  final recorder = FlutterSoundRecorder();
  final audioFile = 'SavingAudios.aac';
  final Num0Sound = AudioPlayer();
  final urlNM0 = "gs://speakup-430fa.appspot.com/رقم.mp3";
                  ...
                  children: [
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: (() async {
                          var urlnm0 = urlNM0;
                          await Num0Sound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B1%D9%82%D9%85.mp3?alt=media&token=ec4cce59-d8e7-4576-8f29-62cc627261f4"));
                        }),
                      ),
                    ),
                    Bounce(
                        ...
                        child: Container(
                            child: Image(
                                height: 350,
                                image: AssetImage("images/رقم.png"))),
                        onPressed: (() async {
                            var urlnm0 = urlNM0;
                            await Num0Sound.play(UrlSource("https://firebasestorage.googleapis.com/v0/b/speakup-430fa.appspot.com/o/%D8%B1%D9%82%D9%85.mp3?alt=media&token=ec4cce59-d8e7-4576-8f29-62cc627261f4"));
                        })),
  ...
  Future handleAfterCloseAction() async {
    ...
    double result = await soundClassifier.predict_vocal(className: 'رقم');
