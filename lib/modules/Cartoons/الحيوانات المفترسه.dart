...
class WildAnimals extends StatefulWidget {
  const WildAnimals({Key? key}) : super(key: key);

  @override
  State<WildAnimals> createState() => _WildAnimals();
}
class _WildAnimals extends State<WildAnimals>
{
  final String Url = 'https://youtu.be/YpRAefpwNek';
    ...
    return BuildOfflineBuilder(
      screen: Scaffold(
        appBar: AppBar(
            ...
            centerTitle: true,
            title: Text("الحيوانات المفترسة", style: TextStyle(fontSize: 30))),
